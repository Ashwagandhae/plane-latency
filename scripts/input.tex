...
\begin{enumerate}
    ...
    \item \textbf{DO 50 JUMPING JACKS} \\ Do 50 jumping jacks. You must record the whole thing. Only one person may perform the jumping jacks at a time but you can cumulative add the team member's jumping jacks to get to 50. \textbf{100 coins}
